...
Every run first checks **Copy Build Information** against the installed source stamp and restores the previous clipboard. Current full runs produce **44 scenario receipts plus the frozen-input check**; the historical 39-scenario receipt above predates repeated configuration cycles and build-information coverage. The suites cover:
