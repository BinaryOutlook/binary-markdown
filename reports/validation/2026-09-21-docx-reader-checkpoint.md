...
### Unresolved empty-line operation
...
This is a failed acceptance case, not an approved deferral or a completed fix. No hidden source characters, macros, global reader preferences or manual formatting repair were introduced to make it pass. The maintainer must decide whether documented native-list behavior is acceptable for this version or whether the requirement needs another representation investigation. Static total-count acceptance remains separately pending as described above.
