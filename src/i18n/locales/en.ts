...
export const webviewMessages = {
  ...
  editorAlignmentLabel: "Column alignment",
  editorAlignmentLeft: "Left",
  editorAlignmentCenter: "Center",
  editorAlignmentRight: "Right",
  editorAlignmentHelp: "Places a capped column within the editor pane. Does not align the text or change Source or exports.",
  editorAlignmentInvalid: "Choose Left, Center, or Right.",
  editorAlignmentSaveFailed: "Could not save the column alignment. The previous setting remains active.",
